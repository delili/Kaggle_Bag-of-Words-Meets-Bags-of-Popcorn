...
if __name__ == '__main__':
    ...
    model = Word2Vec.load("../part2/300features_40minwords_10context")
    ...
    result = forest.predict_proba(X_test)[:,1]

    # Write the test results
    output = pd.DataFrame(data={"id":test["id"], "sentiment":result})
    output.to_csv("BagOfCentroids_proba.csv", index=False, quoting=3)
